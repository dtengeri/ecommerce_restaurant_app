...
abstract class $OrderCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, Basket basket});
...
class _$OrderImpl implements _Order {
  const _$OrderImpl({required this.userId, required this.basket});
  ...
  @override
  String toString() {
    return 'Order(userId: $userId, basket: $basket)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userId, basket);
...
abstract class _Order implements Order {
  const factory _Order(
      ...
      required final Basket basket}) = _$OrderImpl;
