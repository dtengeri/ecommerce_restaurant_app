...
@RoutePage()
class FavouriteFoodsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoPageScaffold(
      child: SafeArea(
        child: Column(
          children: [
            FoodSearchField(searchType: SearchType.favourite),
...
class _FoodList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final foodListAsyncValue = ref.watch(visibleFavouriteFoodListProvider);
