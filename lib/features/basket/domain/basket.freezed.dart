...
/// @nodoc
mixin _$Basket {
  List<BasketItem> get items => throw _privateConstructorUsedError;
...
abstract class $BasketCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<BasketItem> items});
}
...
class _$BasketImpl extends _Basket {
  const _$BasketImpl({required final List<BasketItem> items})
      : _items = items,
        super._();

  final List<BasketItem> _items;
  @override
  List<BasketItem> get items {
...
abstract class _Basket extends Basket {
  const factory _Basket({required final List<BasketItem> items}) = _$BasketImpl;
